...
>
>    * localhoster.exe 起動の時点で自動的にデフォルトブラウザを起動してページを表示します。
>      もしうまくブラウザが起動しない場合は http://127.0.0.1:31764 に接続してください。
>
>
>
>2. ページ内の`cmd_test`をクリックしてください。 
>
>
...
>
>    
>3. 最後に、localhoster.exe の停止テストです。 
>
